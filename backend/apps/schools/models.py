...
class School(TimeStampedModel):
    ...
    address = models.TextField(_('Address'), default='Nawayath Colony, Bhatkal, Karnataka, India')
    address_urdu = models.TextField(_('Address (Urdu)'), default='نوایت کالونی، بھٹکل، کرناٹک، بھارت')
